...
jfk.airlines.create!(name:'Spirit', flight_number: 714, domestic_flight: true)
jfk.airlines.create!(name:'Frontier', flight_number: 117, domestic_flight: true)
jfk.airlines.create!(name:'Southwest', flight_number: 222, domestic_flight: true)
...
jfk.airlines.create!(name:'LUFTHANSA A.G.', flight_number: 022, domestic_flight: false)
# Examples:
#
